...
func (c *crud) create(ctx context.Context, entity light.Tabler) error {
	createFields, err := light.GetFields(entity, "create")
	if err != nil {
		return err
	}
	createFieldsPointers := light.GetFieldsPointers(entity, "create")
...
func (c *crud) update(ctx context.Context, entity light.Tabler) error {
	ent := entity
	updateFields, err := light.GetFields(ent, "update")
	if err != nil {
		return err
	}
	updateFieldsPointers := light.GetFieldsPointers(entity, "update")
...
func (c *crud) find(ctx context.Context, entity light.Tabler, dest interface{}) error {
	ent := entity
	fields, err := light.GetFields(ent)
	if err != nil {
		return err
	}
...
func (c *crud) getCount(ctx context.Context, entity light.Tabler, condition light.Condition) (uint64, error) {
	ent := entity
	var whereState bool
...
func (c *crud) list(ctx context.Context, dest interface{}, entity light.Tabler, limit, offset uint64) error {
	ent := entity
	fields, err := light.GetFields(ent)
	if err != nil {
		return err
...
func (c *crud) listx(ctx context.Context, dest interface{}, entity light.Tabler, condition light.Condition) error {
	fields, err := light.GetFields(entity)
	if err != nil {
		return err
	}
	var whereState bool
...
func (c *crud) count(ctx context.Context, entity light.Tabler, field, ops string) error {
	switch ops {
	case "decr":
	case "incr":
		break
	...
	updateFields, err := light.GetFields(ent, "count")
	if err != nil {
		return err
	}
	updateFieldsPointers := light.GetFieldsPointers(entity, "count")
